...
export default function Project_6() {
    return (
        <div>
            <h2>解构</h2>
            <p>硕士毕业作品</p>
            <p>到了硕士，自己终于明白了一个道理</p>
            <p>Nobody knows shit</p>
            <p>Just do your own thing</p>
            <p>如果不是这迟来的顿悟，硕士毕业或许也会像以前的作品一样，平淡，无趣，求稳</p>
            <p>作品的选址，立意，都是自己一直想做的： 重庆，社会立意题材</p>
            <p>建筑之所以伟大，一直都是因为他不仅仅是个人的表达，也承载了艰巨的社会责任。像这样兼具艺术性与社会性的学科，却在日益走向落寞，实在是让人心酸。</p>
            <p>最后项目的建筑语言其实也是借鉴的，大学五年到最后自己还是没太能学会概念落地和实施</p>
