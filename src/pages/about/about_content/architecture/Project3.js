...
export default function Project_3() {
    return (
        <div>
            ...
            <p>当时的tutor说this is only form-making</p>
            <p>当时的自己太懦弱不敢反驳，而现在的自己，form-making so what. Architecture is about FORM_MAKING! and i see pure genius from these forms. The truest and purest form of pursuit and exploration!</p>
            <p>建筑学越做到后面，自己的一身反骨越明显</p>
